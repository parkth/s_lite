...
<body onload="select_mcode2();">
	<form name="update_form" action="./masterpage.jsp?bo_table=update" method="post" onsubmit="return check()">
	...
	<table width="95%" align="center" border="0" cellspacing="1" bgcolor="000000">
				...
				<tr>				
					...
					<%
						...
						else if(master.equals("2")) { // engineer %>
					<input type="hidden" name="m_engineer" id="m_engineer" value="on" />	
					<input type="hidden" name="m_enable" id="m_enable" value="on" />
					<% }
						else { // user %>
					<input type="hidden" name="m_enable" id="m_enable" value="on" />	
					<% } %>
